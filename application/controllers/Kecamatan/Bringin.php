...
class Bringin extends CI_Controller {

    ///Load model
    public function __construct()
    {
        parent::__construct();
        $this->load->model('bringin_model');
        ///Proteksi Halaman
	...
	{
        $bringin = $this->bringin_model->listing();

        $data = array(  'title'             => 'bringin',
                        'bringin'     => $bringin,
                        'isi'               => 'kecamatan/bringin/data'
        );
	...
	public function tambah()
	{
        ...
        $valid->set_rules('no_berkas','No Berkas','required|is_unique[tb_bringin.no_berkas]',
            array(	'required'    => '%s harus diisi',
					'is_unique'   => '%s sudah ada. Buat Nomor Berkas Baru'));

		$valid->set_rules('nop','NOP','required|is_unique[tb_bringin.nop]',
            array(  'required'      => '%s harus diisi',
                    'is_unique'   => '%s sudah ada. Buat NOP Baru'));
		
		$valid->set_rules('nama','Nama');
			
		$valid->set_rules('nik','NIK','required|is_unique[tb_bringin.nik]',
            array(  'required'    => '%s harus diisi',
        ...
        if($valid->run()==FALSE)    {
            ...
            $data = array(  'title'     => 'Tambah Data bringin',
                            'isi'       => 'kecamatan/bringin/tambah'
            );
            $this->load->view('layout/wrapper', $data, FALSE);
        ///Masuk Database
        }else{
            ...
            $this->bringin_model->tambah($data);
            $this->session->set_flashdata('sukses', 'Data telah ditambah');
            redirect(base_url('kecamatan/bringin'),'refresh');
        }
    }
	...
	public function edit($id)
	{
        ...
        $bringin = $this->bringin_model->detail($id);
        ...
        if($valid->run()==FALSE)    {
            ...
            $data = array(  'title'              => 'Edit Data bringin (no berkas = '.$bringin->no_berkas.' )',
                            'bringin'      => $bringin,
                            'isi'                => 'kecamatan/bringin/edit'
            );
            $this->load->view('layout/wrapper', $data, FALSE);
        ///Masuk Database
        }else{
    ...
    {
        $data = array('id' => $id);
        $this->bringin_model->delete($data);
	...
	public function export_excel()
	{
        ...
        $data = array(  'title'             => 'Daftar Nominatif PTSL Kecamatan bringin',
                        'bringin'     => $bringin
        );
		$this->load->view('kecamatan/bringin/laporan_excel', $data, FALSE);
	}
}
