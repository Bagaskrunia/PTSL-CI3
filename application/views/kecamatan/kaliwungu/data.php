<div class="pull-left">
    <a href="<?php echo base_url('kecamatan/kaliwungu/tambah')?>" class="btn btn-success btn-lg">
        <i class="fa fa-plus"></i>&nbsp;Tambah Baru
    </a>
    <h1>Data Pemohon</h1>
</div>
<div class="pull-right">
    <a href="<?php echo base_url('kecamatan/kaliwungu/export_excel')?>" class="btn btn-warning btn-sm">
    ...
    <table id="example1" class="table table-bordered">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="<?php echo base_url('kecamatan/kaliwungu/edit/'.$kaliwungu->id)?>"
                    class="btn btn-warning btn-xs"><i class="fa fa-edit"></i> Edit</a>
                    <a href="<?php echo base_url('kecamatan/kaliwungu/delete/'.$kaliwungu->id)?>"
